...
public class BlogMockedData {
  //list of blog posts
  private List<com.salisuwy.Blog> blogs;
  ...
  public BlogMockedData(){
    blogs = new ArrayList<com.salisuwy.Blog>();
    blogs.add(new com.salisuwy.Blog(1, "Go up, up and away with your Google Assistant",
    ...
    blogs.add(new com.salisuwy.Blog(2, "Get local help with your Google Assistant",
    ...
    blogs.add(new com.salisuwy.Blog(3, "The new maker toolkit: IoT, AI and Google Cloud Platform",
    ...
    blogs.add(new com.salisuwy.Blog(4, "Learn more about the world around you with Google Lens and the Assistant",
    ...
    blogs.add(new com.salisuwy.Blog(5, "7 ways the Assistant can help you get ready for Turkey Day",
  ...
  // return all blogs
  public List<com.salisuwy.Blog> fetchBlogs() {
    return blogs;
  }

  // return blog by id
  public com.salisuwy.Blog getBlogById(int id) {
    for(com.salisuwy.Blog b: blogs) {
      if(b.getId() == id) {
        return b;
      }
    }
  ...
  // search blog by text
  public List<com.salisuwy.Blog> searchBlogs(String searchTerm) {
    List<com.salisuwy.Blog> searchedBlogs = new ArrayList<com.salisuwy.Blog>();
    for(com.salisuwy.Blog b: blogs) {
  ...
  // create blog
  public com.salisuwy.Blog createBlog(int id, String title, String content) {
    com.salisuwy.Blog newBlog = new com.salisuwy.Blog(id, title, content);
    blogs.add(newBlog);
    return newBlog;
  }

  // update blog
  public com.salisuwy.Blog updateBlog(int id, String title, String content) {
    for(com.salisuwy.Blog b: blogs) {
      if(b.getId() == id) {
